...
func TestGoUpSkipCallDown(t *testing.T) {
	setup()
	e.Go(4)
	e.Call(3, DOWN)
...
func TestGoDownSkipCallUp(t *testing.T) {
	setup()
	e.currentFloor = 5
	e.Go(1)
	e.Call(3, UP)
...
func TestGoUpStopAtCallUp(t *testing.T) {
	setup()
	e.Go(4)
	e.Call(3, UP)
...
func TestGoDownStopAtCallDown(t *testing.T) {
	setup()
	e.currentFloor = 5
	e.Go(1)
	e.Call(3, DOWN)
